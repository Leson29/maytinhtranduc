            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-about-us">
                        <h2 style="font-family:Impact;">TRAN DUC<span> COMPUTER</span></h2>
                       <address>
                        <span>Chuyên cung cấp các sản phẩm công nghệ!</span>
                        <p><i class="fa fa-phone"></i> +84 375.000.333</p>
                        <p><i class="fa fa-map-marker"></i> Số nhà 11/1 Đường Bắc Kạn - Tổ 8 - P. Hoàng Văn Thụ - TP. Thái Nguyên - T. Thái Nguyên, Thái Nguyên.</p>
                    </address>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy;2023 By Hải Sơn <a href="index.php" target="_blank">MÁY TÍNH TRẦN ĐỨC</a></p>
                    </div>
                </div>
                <div class="col-md-4">
